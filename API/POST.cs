...
namespace SpaceNET.API
{
    public class POST
    {
        internal static POST Null => new POST(new Dictionary<string, string>(), new Dictionary<string, FormFile>());
        private Dictionary<string, string> Arguments;
        private Dictionary<string, FormFile> Files;

        internal POST(Dictionary<string, string> arguments, Dictionary<string, FormFile> files)
        {
            Arguments = arguments;
            Files = files;
        }
